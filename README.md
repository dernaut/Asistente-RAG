...
- Retriever MultiQueryRetriever para obtener información con un modelo y un prompt personalizado y un base retriever donde se contiene la información al principio.
